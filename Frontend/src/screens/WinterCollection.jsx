...
const WinterCollection = () => {
  ...
  const { categoryProducts, error, loading } = useCategoryProduct('winterCollection');
        ...
        categoryProducts.length > 0 ? <div className=''>
          ...
          </div>
          {
            option === 1 ? <div className='grid grid-cols-2 px-2 my-20 xsm:gap-1 md:gap-4 xl:mx-20 lg:mx-5 lg:gap-7'>
              ...
              {
                filteredProducts.length > 0 ? filteredProducts.map((winter) => <SecondSingleProduct wish={false} key={winter._id} singleProduct={winter} />) : ""
              }
            </div> : option === 3 ? <div className='grid grid-cols-1 px-3 my-20 mr-4 lg:mx-5 xl:px-20'>
              {
                filteredProducts.length > 0 ? filteredProducts.map((winter) => <ThirdSingleProduct wish={false} key={winter._id} singleProduct={winter} />) : ""
              }
            </div> : option === 4 ? <div className='grid grid-cols-3 px-3 my-20 gap-3 lg:mx-5 lg:gap-5 xl:px-20'>
              {
                filteredProducts.length > 0 ? filteredProducts.map((winter) => <SingleProduct type={2} wish={false} key={winter._id} singleProduct={winter} />) : ""

              }
            </div> : option === 5 ? <div className='grid grid-cols-4 px-3 my-20 gap-4 lg:mx-4 xl:px-20'>
              {
                filteredProducts.length > 0 ? filteredProducts.map((winter) => <SingleProduct type={3} wish={false} key={winter._id} singleProduct={winter} />) : ""
              }
            </div> : option === 6 ? <div className='grid grid-cols-5 px-3 my-20 gap-4 lg:mx-4 xl:px-20'>
              {
                filteredProducts.length > 0 ? filteredProducts.map((winter) => <SingleProduct type={4} wish={false} key={winter._id} singleProduct={winter} />) : ""
              }
            </div> : option === 7 ? <div className='grid grid-cols-6 px-3 my-20 gap-4 lg:mx-4 xl:px-20'>
              {
                filteredProducts.length > 0 ? filteredProducts.map((winter) => <SingleProduct type={5} wish={false} key={winter._id} singleProduct={winter} />) : ""
              }
            </div> : ""
          }
