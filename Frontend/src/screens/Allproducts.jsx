    ...
    <div>
      ...
      <div className='flex justify-between gap-9 xsm:gap-20 sm:gap-0 items-center px-2 w-full xl:px-20'>
        ...
        <div className='flex gap-3 items-center md:justify-center w-1/3'>
          <div className='border cursor-pointer hover:bg-slate-800 hover:border-white hover:border duration-300 flex flex-col justify-center space-y-[3px] py-1 border-slate-500 w-8 h-7' onClick={() => setOption(2)}>
            <div className={`min-h-[5px] ${option === 2 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300 w-10/12 mx-auto pl-1 pr-1`}></div>
            <div className={`min-h-[5px] ${option === 2 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300 w-10/12 mx-auto pl-1 pr-1`}></div>
            <div className={`min-h-[5px] ${option === 2 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300 w-10/12 mx-auto pl-1 pr-1`}></div>
          </div>
          <div className='border  cursor-pointer hover:bg-slate-800 hover:border-white hover:border border-slate-500 md:hidden w-8 h-7 p-[2px]' onClick={() => setOption(3)}>
            <div className={`w-full h-full ${option === 3 ? "bg-slate-800 hover:bg-white duration-300" : "bg-[#878787]"}`}></div>
          </div>
          <div className='border border-slate-400  cursor-pointer hover:bg-slate-800 hover:border-white hover:border w-8 h-7 flex gap-1 p-[2px]' onClick={() => setOption(1)}>
            <div className={`w-1/2 h-full ${option === 1 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300`}></div>
            <div className={`w-1/2 h-full ${option === 1 ? "bg-slate-800 " : "bg-[#878787]"} hover:bg-white duration-300`}></div>
          </div>
          <div className='border border-slate-400  cursor-pointer hover:bg-slate-800 hover:border-white hover:border w-8 h-7 hidden md:flex gap-1 p-[2px]' onClick={() => setOption(4)}>
            <div className={`w-1/2 h-full ${option === 4 ? "bg-slate-800 " : "bg-[#878787]"} hover:bg-white duration-300`}></div>
            <div className={`w-1/2 h-full ${option === 4 ? "bg-slate-800 " : "bg-[#878787]"} hover:bg-white duration-300`}></div>
            <div className={`w-1/2 h-full ${option === 4 ? "bg-slate-800 " : "bg-[#878787]"} hover:bg-white duration-300`}></div>
          </div>
          <div className='border border-slate-400  cursor-pointer hover:bg-slate-800 hover:border-white hover:border w-fit h-7 hidden md:flex gap-1 p-[2px]' onClick={() => setOption(5)}>
            <div className={`min-w-[6px] h-full ${option === 5 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300`}></div>
            <div className={`min-w-[6px] h-full ${option === 5 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300`}></div>
            <div className={`min-w-[6px] h-full ${option === 5 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300`}></div>
            <div className={`min-w-[6px] h-full ${option === 5 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300`}></div>
          </div>
          <div className='border border-slate-400  cursor-pointer hover:bg-slate-800 hover:border-white hover:border w-fit xl:flex xl:gap-1 h-7 hidden p-[2px]' onClick={() => setOption(6)}>
            <div className={`min-w-[6px] h-full ${option === 6 ? "bg-slate-800 " : "bg-[#878787]"} hover:bg-white duration-300`}></div>
            <div className={`min-w-[6px] h-full ${option === 6 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300`}></div>
            <div className={`min-w-[6px] h-full ${option === 6 ? "bg-slate-800 " : "bg-[#878787]"} hover:bg-white duration-300`}></div>
            <div className={`min-w-[6px] h-full ${option === 6 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300`}></div>
            <div className={`min-w-[6px] h-full ${option === 6 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300`}></div>
          </div>
          <div className='border border-slate-400 w-fit cursor-pointer hover:bg-slate-800 hover:border-white hover:border  xl:flex xl:gap-1 h-7 hidden p-[2px]' onClick={() => setOption(7)}>
            <div className={`min-w-[6px] h-full ${option === 7 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300`}></div>
            <div className={`min-w-[6px] h-full ${option === 7 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300`}></div>
            <div className={`min-w-[6px] h-full ${option === 7 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300`}></div>
            <div className={`min-w-[6px] h-full ${option === 7 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300`}></div>
            <div className={`min-w-[6px] h-full ${option === 7 ? "bg-slate-800" : "bg-[#878787]"} hover:bg-white duration-300`}></div>
        ...
        option === 1 ? <div className='grid grid-cols-2 px-2 my-20 xsm:gap-1 md:gap-4 xl:mx-20 lg:mx-5 lg:gap-7'>
          {
            allProducts.length > 0 ?
              allProducts.map((product) => {
                return <div key={product.id} className='flex items-center justify-center'> <SingleProduct type={1} wish={false} className="col-span-1" singleProduct={product} />
                </div>
              })
              : ""
          }
          ...
          {
            allProducts.length > 0 ? allProducts.map((product) => <SecondSingleProduct wish={false} key={product.id} singleProduct={product} />) : ""
          }
        </div> : option === 3 ? <div className='grid grid-cols-1 px-3 my-20 mr-4 lg:mx-5 xl:px-20'>
          {
            allProducts.length > 0 ? allProducts.map((product) => <ThirdSingleProduct wish={false} key={product.id} singleProduct={product} />) : ""
          }
        </div> : option === 4 ? <div className='grid grid-cols-3 px-3 my-20 gap-3 lg:mx-5 lg:gap-5 xl:px-20'>
          {
            allProducts.length > 0 ? allProducts.map((product) => <SingleProduct type={2} wish={false} key={product.id} singleProduct={product} />) : ""

          }
        </div> : option === 5 ? <div className='grid grid-cols-4 px-3 my-20 gap-4 lg:mx-4 xl:px-20'>
          {
            allProducts.length > 0 ? allProducts.map((product) => <SingleProduct type={3} wish={false} key={product.id} singleProduct={product} />) : ""
          }
        </div> : option === 6 ? <div className='grid grid-cols-5 px-3 my-20 gap-4 lg:mx-4 xl:px-20'>
          {
            allProducts.length > 0 ? allProducts.map((product) => <SingleProduct type={4} wish={false} key={product.id} singleProduct={product} />) : ""
          }
        </div> : option === 7 ? <div className='grid grid-cols-6 px-3 my-20 gap-4 lg:mx-4 xl:px-20'>
          {
            allProducts.length > 0 ? allProducts.map((product) => <SingleProduct type={5} wish={false} key={product.id} singleProduct={product} />) : ""
          }
        </div> : ""
      }
